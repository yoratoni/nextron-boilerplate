        ...
        <div className="flex flex-col gap-6 justify-center items-center">
            <div className="w-full max-w-sm">
                ...
                <pre className="text-sm leading-5">
                    {environment ? JSON.stringify(environment, null, 4) : "..."}
                </pre>
            </div>
            ...
            <div className="w-full max-w-sm">
                ...
                <pre className="text-sm leading-5">
                    {preferences ? JSON.stringify(preferences, null, 4) : "..."}
                </pre>
            </div>

            <div className="w-full max-w-sm gap-2 flex flex-col text-left items-start">
                <h3 className="font-medium">System information ({preferences?.current.sysInfo.refreshInterval || 1500}ms interval):</h3>
                ...
                <span key={1} title="System memory usage" className="flex justify-center items-center text-sm font-normal">
